...
export default function Beforpage() {
  ...
  useEffect(() => {
    const savedRows1 = localStorage.getItem("monitoringRows_befor");
    if (savedRows1) {
  ...
  useEffect(() => {
    const a  = localStorage.getItem("field_16");
    ...
    },
{
 ...
 {/* دکمه‌ها */}
      <div className="mb-3 d-flex gap-2">
        ...
        <button className="btn btn-info" onClick={enableAllValidCalculations}>
           ویرایش قیمت
        </button>
