  ...
  return (
    <div style={{ width: "100%", padding: 5, direction: "rtl" }}>
      ...
      >
        <thead>
          <tr>
            <td className="Title">شماره فصل</td>
            ...
            <td className="Title">مبلغ به حروف (ریال)</td>
          </tr>
        </thead>
        ...
        <tbody>
          {rows.map((row, index) => (
            <tr key={index}>
              ...
              <td className="cream">{numberToPersianWords(localStorage.getItem(row.source[2]))} ریال</td>
            </tr>
          ))}
        </tbody>
      </table>
