...
const clearGrid = () => {
  ...
  const extractDurringExecutionTable = () => {
  return {
    id: "monitoring_durring_execution",
    type: "direct",
    title: "نظارت حین اجرا",
    columns: [
      "شماره ردیف",
      "شرح ردیف",
      "تحویل شدنی",
    ...
    rows: rows.map((r) => {
      ...
      const finalPrice = getCalculatedPrice(r);
      ...
      return {
        ...
        subject: r.subject ?? "",
        deliver: r.deliver ?? "",
        unitprice: !isNaN(unit) ? unit : null,
        coefficient_a: r.enableCalc ? a : null,
        coefficient_b: r.enableCalc ? b : null,
        totalprice: finalPrice ?? null,
        isManual: r.isManual || false
      };
    }),
    total: totalCalculatedPrice ?? 0,
    currency: "ریال"
  };
};
    ...
    },
{
 ...
 {/* دکمه‌ها */}
  ...
  onClick={() => {
    console.log(extractDurringExecutionTable());
  }}
>
  تست خروجی جدول نوع ۲ (حین اجرا)
</button>
