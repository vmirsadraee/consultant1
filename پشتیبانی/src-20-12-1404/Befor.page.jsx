...
useEffect(() => {
  ...
  const extractBeforeExecutionTable = () => {
  return {
    id: "monitoring_before_execution",
    type: "direct",
    ...
    rows: rows.map(r => {
      ...
      return {
        ...
        coefficient: r.enableCalc ? a : null,
  ...
  onClick={() => {
    console.log(extractBeforeExecutionTable());
  }}
>
  تست خروجی جدول نوع ۲
</button>
